...
class PrimeMembers extends StatefulWidget {
  @override
  _PrimeMembersState createState() => _PrimeMembersState();
}

class _PrimeMembersState extends State<PrimeMembers> {
        ...
        body: StreamBuilder(
            ...
            builder:
              ...
              if (snapshot.data.docs.isEmpty) {
                return new Center(
                  child: Text(
                    'There are no Prime Members yet!',
                    overflow: TextOverflow.ellipsis,
                    style: GoogleFonts.lato(
                      textStyle: TextStyle(
                          color: Colors.white,
